    ...
    def __call__(
        ...
        **kwds,
        ...
        EXAMPLES::
            ...
            >>> from estimator import *
            >>> params = schemes.NTRUHPS2048509Enc.updated(Xs=ND.SparseTernary(32))
            >>> NTRU.primal_hybrid(params, mitm=False, babai=False)
            rop: ≈2^88.8, red: ≈2^87.9, svp: ≈2^87.6, β: 141, η: 19, ζ: 296, |S|: ≈2^50.2, d: 45...

            >>> NTRU.primal_hybrid(params, mitm=False, babai=True)
            rop: ≈2^46.3, red: ≈2^46.3, svp: ≈2^39.2, β: 40, η: 2, ζ: 63, |S|: ≈2^16.9, d: 514, ...

            >>> NTRU.primal_hybrid(params, mitm=True, babai=True)
            rop: ≈2^86.0, red: ≈2^84.2, svp: ≈2^85.5, β: 107, η: 2, ζ: 369, |S|: ≈2^88.8, d: 345...
